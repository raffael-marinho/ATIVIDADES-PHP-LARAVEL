...
Route::resource('users', UserController::class)
    ...
    ->middleware('auth');
Route::prefix('debits')->middleware('auth')->group(function () {
    Route::get('/', [DebitController::class, 'index'])->name('debits.index');
    Route::get('/{user}', [DebitController::class, 'show'])->name('debits.show');
    Route::post('/{user}/pay', [DebitController::class, 'pay'])->name('debits.pay');
});